...
- ถ้ายังไม่มีฐานข้อมูล Mariabd ให้อ่านไฟล์นี้ เพื่อติดตั้ง `assets/install_mariadb_with_docker.txt`

- ถ้ายังไม่มีตารางให้อ่านไฟล์นี้ เพื่อสร้างตาราง `assets/create_table_ecommerce.sql`
